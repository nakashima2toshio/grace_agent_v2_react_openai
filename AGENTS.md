...
| **それ以外の全 LLM 用途**（Q&A生成・データDL・Plan/Execute/Reasoning/Confidence/Replan/ReAct 等） | **Anthropic** | `Codex-sonnet-4-6`（軽量 `Codex-haiku-4-5-20251001`） | `ANTHROPIC_API_KEY` |
